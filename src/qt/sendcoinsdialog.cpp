    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Multicoin address (e.g. Ler4HNAEfwYhBmGXcFP2Po1NpRUEiK8km2)"));
#endif
...
SendCoinsEntry *SendCoinsDialog::addEntry()
{
    ...
    // entry->setStyleSheet("SendCoinsEntry {background-image: url(:/images/background);}");
...
void SendCoinsDialog::paintEvent(QPaintEvent* evt) {
  QStyleOption opt;
  opt.init(this);
  QPainter p(this);
