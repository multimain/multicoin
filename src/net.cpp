...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Multicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"dnsseed1.multicoin.me", "dnsseed2.multicoin.me"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"multicointools.com", "testnet-seed.multicointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Multicoin is probably already running."), addrBind.ToString().c_str());
        else
